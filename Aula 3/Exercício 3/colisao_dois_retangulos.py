...
def verifica_colisao(retangulo1_coordenadaX, retangulo1_coordenadaY, dimensaoX_retangulo1_L,\
dimensaoY_retangulo1_A, retangulo2_coordenadaX, dimensaoX_retangulo2_L,\
dimensaoY_retangulo2_A):
    if ((retangulo1_coordenadaX + dimensaoX_retangulo1_L > retangulo2_coordenadaX) and
        ...
        print ("\nOs retangulos colidiram!")
        return True
    else:
        #Se os retangulos não colidiram, informa na tela: Os retangulos não colidiram!
        print ("\nsOs retangulos não colidiram!")
        return False

verifica_colisao(retangulo1_coordenadaX, retangulo1_coordenadaY, dimensaoX_retangulo1_L,\
dimensaoY_retangulo1_A, retangulo2_coordenadaX, dimensaoX_retangulo2_L,\
dimensaoY_retangulo2_A)
